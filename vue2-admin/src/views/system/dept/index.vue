...
<script>
import { listDept, getDept, delDept, addDept, updateDept, listDeptExcludeChild } from '@/api/system'
  ...
  methods: {
    ...
    getTreeselect() {
      listDept().then(response => {
        this.deptOptions = []
        const data = { deptId: 0, deptName: '顶级部门', children: [] }
        data.children = this.handleTree(response.data, 'deptId')
