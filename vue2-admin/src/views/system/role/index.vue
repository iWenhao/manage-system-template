    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="菜单权限">
          ...
          <el-tree class="tree-border" :data="menuOptions" show-checkbox ref="menu" node-key="id" :check-strictly="!form.menuCheckStrictly" empty-text="加载中，请稍候" :props="defaultProps" />
        </el-form-item>
...
<script>
import { listRole, getRole, delRole, addRole, updateRole, dataScope, changeRoleStatus } from '@/api/system'
import { treeselect as menuTreeselect, roleMenuTreeselect } from '@/api/system'
  ...
  methods: {
    ...
    handleDataScope(row) {
      ...
      getRole(row.roleId).then(response => {
        ...
        this.$nextTick(() => {
          this.$refs.dept.setCheckedKeys(response.data.deptIds)
        })
        this.title = '分配数据权限'
      })
    },
