<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="参数编号" prop="configId" width="80" />
      ...
      <el-table-column label="系统内置" align="center" width="80">
        <template slot-scope="scope">
          <el-tag :type="scope.row.configType === 'Y' ? 'primary' : 'success'">{{ typeFormat(scope.row) }}</el-tag>
        </template>
      </el-table-column>
...
<script>
import { listConfig, getConfig, delConfig, addConfig, updateConfig, refreshCache } from '@/api/system'
